import type { CircuitParams, TimeSeriesPoint, CircuitType, DampingType, CircuitResponse, InputType, Complex } from '../types/circuit';
import { CRITICAL_DAMPING_TOLERANCE } from './constants';
